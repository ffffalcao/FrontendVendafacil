...
import { Vendafacil } from '@/types';
import { UsuarioService } from '@/service/usuarioService';

const Usuario = () => {
    let usuarioVazio: Vendafacil.Usuario = {
        id: 0,
        nome: '',
        login: '',
        senha: '',
    ...
    const [usuarios, setUsuarios] = useState<Vendafacil.Usuario[]>([]);
    const [usuarioDialog, setUsuarioDialog] = useState(false);
    const [deleteUsuarioDialog, setDeleteUsuarioDialog] = useState(false);
    const [deleteUsuariosDialog, setDeleteUsuariosDialog] = useState(false);
    const [usuario, setUsuario] = useState<Vendafacil.Usuario>(usuarioVazio);
    const [selectedUsuarios, setSelectedUsuarios] = useState<Vendafacil.Usuario[]>([]);
    ...
    const editUsuario = (usuario: Vendafacil.Usuario) => {
        setUsuario({ ...usuario });
        setUsuarioDialog(true);
    };

    const confirmDeleteUsuario = (usuario: Vendafacil.Usuario) => {
        setUsuario(usuario);
    ...
    const idBodyTemplate = (rowData: Vendafacil.Usuario) => {
        return (
            <>
    ...
    const nomeBodyTemplate = (rowData: Vendafacil.Usuario) => {
        return (
            <>
    ...
    const loginBodyTemplate = (rowData: Vendafacil.Usuario) => {
        return (
            <>
    ...
    const emailBodyTemplate = (rowData: Vendafacil.Usuario) => {
        return (
            <>
    ...
    const actionBodyTemplate = (rowData: Vendafacil.Usuario) => {
        return (
            <>
